...
const creator = '601123550412'
run = process.uptime() 
runtimee = `${kyun(run)}`
prefix = "𝐌𝐮𝐥𝐭𝐢"
banChats = false
memek =`
YT: https://youtube.com/channel/9_roeowpzl

Github: https://github.com/KhairilOFC

IG: bangkelah_71`
require('./body.js')
nocache('./body.js', module => console.log(`${module} is now updated!`))
require('./index.js')
nocache('./index.js', module => console.log(`${module} is now updated!`))
console.log(color('SC BY RANZ'))
sleep(4000)
console.log(color('Bukan untuk dijual kntl'))

const starts = async (client = new WAConnection()) => {
    client.autoReconnect = ReconnectMode.onConnectionLost
    client.logger.level = 'warn'
    client.version = [2, 2143, 3]
    client.browserDescription = ['B O D Y ', 'EDGE', '94.0.992.47'] 
    client.on('qr', () => {
    ...
    client.on('chat-update', async (message) => {
        require('./body.js')(client, message)
    })
